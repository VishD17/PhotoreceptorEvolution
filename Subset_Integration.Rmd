...
mouse_subset = subset(mouse, cells = WhichCells(mouse, downsample = 78, seed = 12345))
marmoset_subset = subset(int_marmoset, cells = WhichCells(int_marmoset, downsample = 150, seed = 12345))
chicken_subset = subset(chicken, cells = WhichCells(chicken, downsample = 80, seed = 12341))
...
gene_lists <- list(marmoset_genes, cow_genes, squirrel_genes, lizard_genes, mouse_genes)
...
ph <- merge(ortho_lizard, y = c(ortho_cow, ortho_squirrel, ortho_marmoset, ortho_human, ortho_mouse), add.cell.ids = c("cow", "squirrel", "marmoset", "human", "lizard", "mouse"), project = "merge")
table(ph$species)
```
