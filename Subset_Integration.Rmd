...
chicken_subset = subset(chicken, cells = WhichCells(chicken, downsample = 40, seed = 12345))
...
gene_lists <- list(marmoset_genes, cow_genes, squirrel_genes, lizard_genes, mouse_genes, chicken_genes)
...
ph <- merge(ortho_lizard, y = c(ortho_cow, ortho_squirrel, ortho_marmoset, ortho_human, ortho_mouse, ortho_chicken), add.cell.ids = c("lizard", "cow","squirrel", "marmoset", "human", "mouse", "chicken"), project = "merge")
table(ph$species)
```
...
OrthoObject2 = ClusterSeurat(ph, nfeatures = 2000, numPCs = 15, integrate.by = "species", cluster_resolution = 0.935)
```
...
```{r}
#UMAP Plots
celltype_colors <- c("rod" = "limegreen", "s-cone" = "cornflowerblue", "l/m-cone" = "brown1", "double-cone" = "orange")
DimPlot(OrthoObject2, group.by = "celltype", cols = celltype_colors)
